...
import com.book.admin.user.service.MasterOrderReportService;
import com.book.admin.user.service.OrderDetailReportService;
import com.book.common.entity.ReportItem;
import com.book.common.entity.ReportType;
...
public class ReportRestController {
    ...
    public List<ReportItem> getReportDataByDatePeriod(@PathVariable("period") String period) {
        ...
        switch (period) {
            ...
            case "last_6_months":
                return masterOrderReportService.getReportDataLast6Months(ReportType.DAY);

            case "last_year":
                return masterOrderReportService.getReportDataLastYear(ReportType.DAY);
